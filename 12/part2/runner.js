...
const isMoveAllowed = (self, neighbor) => {
    return (neighbor.height + 1 >= self.height);
};
...
const getShortestPath = (startNode, targetHeight) => {
...
const endNode = findNode(gridMap, 'E');
const pathLength = getShortestPath(endNode, 0);
